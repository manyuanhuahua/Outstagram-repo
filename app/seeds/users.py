...
def seed_users():
    ...
    Eva = User(
        username='Eva', email='Eva@aa.io', fullname="Eva User", profile_image="https://s.itl.cat/pngfile/s/83-832842_unique-dps-for-fb-with-quotes-visit-us.jpg", bio="Eva User's bio", password='password')
    Leo = User(
        username='Leo', email='Leo@aa.io', fullname="Leo User", profile_image="https://www.teahub.io/photos/full/364-3646944_cool-profile-pictures-hd-pic-hwb37635-cat-with.jpg", bio="Leo User's bio", password='password')
    Luca = User(
        username='Luca', email='Luca@aa.io', fullname="Luca User", profile_image="https://cdn.pixabay.com/photo/2016/03/26/22/13/man-1281562__340.jpg", bio="Luca User's bio", password='password')
    Lily = User(
        username='Lily', email='Lily@aa.io', fullname="Lily User", profile_image="https://cdn.pixabay.com/photo/2016/04/21/22/29/girl-1344646__340.jpg", bio="Lily User's bio", password='password')
    Jack = User(
        username='Jack', email='Jack@aa.io', fullname="Jack User", profile_image="https://images.unsplash.com/photo-1510917065317-aa26965fe730?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8ZGFyayUyMHByb2ZpbGV8ZW58MHx8MHx8&w=1000&q=80", bio="Jack User's bio", password='password')
    Nora = User(
        username='Nora', email='Nora@aa.io', fullname="Nora User", profile_image="https://i.pinimg.com/originals/69/e9/3b/69e93bc04784b616a8eabde78d5bcb40.jpg", bio="Nora User's bio", password='password')
    Theo = User(
        username='Theo', email='Theo@aa.io', fullname="Theo User", profile_image="https://i.pinimg.com/736x/9a/68/7c/9a687c559de12b8d5df94e98508d5469.jpg", bio="Theo User's bio", password='password')
    David = User(
        username='David', email='David@aa.io', fullname="David User", profile_image="https://i.pinimg.com/736x/68/ff/f1/68fff1b8797527499b7de8e78c774b14.jpg", bio="David User's bio", password='password')
    Leila = User(
        username='Leila', email='Leila@aa.io', fullname="Leila User", profile_image="https://1.bp.blogspot.com/-bGRGaZpDrYU/YTdYgCA0Z0I/AAAAAAAAGuc/PlWykAd3NlE3lMEldEi2S9kcXyTTeswzQCLcBGAsYHQ/s500/2d2ab8e714ae13c8b7fe280095f10e44.jpg", bio="Leila User's bio", password='password')
    Elias = User(
        username='Elias', email='Elias@aa.io', fullname="Elias User", profile_image="https://i.pinimg.com/550x/bd/80/b1/bd80b1e1bc40234c3527d6b70c899484.jpg", bio="Elias User's bio", password='password')
    Jacob = User(
